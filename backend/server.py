...
SERVICES = [
    ...
    {"id": "ar-followup", "name": "AR Follow-Up", "icon": "PhoneCall", "description": "Aggressive aged AR follow-up to recover revenue and reduce days in AR."},
    {"id": "denial-followup", "name": "Denial Follow-Up", "icon": "ShieldAlert", "description": "Root-cause denial management with payer-specific resolution playbooks."},
